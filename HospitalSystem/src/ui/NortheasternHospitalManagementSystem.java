 ...
 * @author arpitarai
 */
public class NortheasternHospitalManagementSystem extends javax.swing.JFrame {
     ...
     */
    public NortheasternHospitalManagementSystem() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NortheasternHospitalManagementSystem.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new NortheasternHospitalManagementSystem().setVisible(true);
            }
        });
    }
